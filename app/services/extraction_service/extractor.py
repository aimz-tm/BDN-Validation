...
from app.services.extraction_service.normalizer import normalize_all
...
def extract_fields(file_path: str, ocr_result: dict | None = None, doc_type: str = "DIGITAL") -> dict[str, Any]:
    ...
    if doc_type == "HANDWRITTEN":
        from app.services.extraction_service.handwritten_extractor import HandwrittenExtractor
        extractor = HandwrittenExtractor(text, ocr_conf)
    else:
        from app.services.extraction_service.digital_extractor import DigitalExtractor
    ...
    try:
        from app.services.document_service.extractor import extract_with_spacy
