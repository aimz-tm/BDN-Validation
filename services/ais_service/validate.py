...
from services.ais_service.history import fetch_positions
from services.ais_service.lookup import vessel_details
from services.timezone_service.converter import delivery_window_utc
from services.validation_service.features import build_feature_vector, descriptive_flags
from services.validation_service.maps import render_track_map
from services.validation_service.model import model_loaded, score_feature_vector
from stub.mock_pipeline import _mock_map_html

# Re-use synthetic track builder for demo fallback
from services.validation_service import synthetic_data
