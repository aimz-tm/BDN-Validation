...
from core.config_loader import get_config, reload_config, save_config
...
async def validate_bdn(
    ...
    try:
        ...
        from services.document_service.pdf_utils import prepare_upload
...
def get_vessel(imo: str):
    ...
    from services.identity_service import registry_fallback
...
async def ocr_extract_endpoint(file: UploadFile = File(...)):
    ...
    try:
        from services.ocr_service.engine import extract as ocr_engine
